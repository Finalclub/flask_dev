...
datapath = {
	'indian': 'D:/Projections/datasource/hyperimage/Indian_pines/Indian_pines_corrected.mat',
	'Salinas': 'D:/Projections/datasource/hyperimage/Salinas/salinas_corrected.mat'
	}

gtpath = {
	'indian': 'D:/Projections/datasource/hyperimage/Indian_pines/Indian_pines_gt.mat',
	'Salinas': 'D:/Projections/datasource/hyperimage/Salinas/salinas_gt.mat'
	}

readInstance = ri.ReadImage()
spectralImage = readInstance.funReadMat(datapath['Salinas'])
reshapedImage = spectralImage.reshape(-1, spectralImage.shape[-1])
groundTruth = readInstance.funReadMat(gtpath['Salinas']).reshape(-1, 1)
...
if __name__ == '__main__':
	...
	for bands in range(5, 46, 5):
		subThread = RT(funIntegratedExperiment, args=(reshapedImage, bands))
